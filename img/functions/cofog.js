...
BubbleTreeStyles.Cofog1 = {
	// 일반공공행정
	'010. ': { icon: '/img/functions/government-uk.svg',color: '#ff4040'},
	
	// 공공질서 및 안전
	'020. ': { icon: '/img/functions/order-safety.svg' ,color: '#ff4040'},
	
	// 교육
	'050. ': { icon: '/img/functions/education.svg' ,color: '#ff4040' },
	
	// 문화 및 관광
	'060. ': { icon: '/img/functions/culture.svg' ,color: '#ff4040'},
	
	// 환경보호
	'070. ': { icon: '/img/functions/environment.svg' ,color: '#ff4040' },
	
	// 사회복지
	'080. ': { icon: '/img/functions/helping-others.svg' ,color: '#ff4040' },
	
	// 보건
	'090. ': { icon: '/img/functions/health.svg' ,color: '#ff4040' },
	...
	// 국토 및 지역개발
	'140. ': { icon: '/img/functions/our-streets.svg' },
