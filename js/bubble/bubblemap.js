...
OpenSpending.BubbleMap = function (config) {
    ...
    var onNodeClick = function(node) {
        ...
        self.layer.tooltips(function (data) {
          ...
          return [data.region, '<div class="amount">'+famount+'</div>'];
        });
    ...
    var loadData = function() {
        ...
        self.map.loadMap(opts.map.url, function() {
            ...
            console.log(self.layer.tooltips);
    ...
    $('.select_region').bind('click', function(d) {
      $('#region_category').html(this.innerHTML);
      var a = this.getAttribute('data-region');
      selectedRegion = selectedRegion==a ? null : a;
      loadData();
    })
